...
function Update() {
  ...
  useEffect(() => {
    const fetchRecipe = async () => {
      try {
        const response = await axios.get(`https://foodrecipe-fullstack.onrender.com/recipes/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        const response = await axios.put(`https://foodrecipe-fullstack.onrender.com/recipes/${id}`, formattedData, {
            headers: { 
